...
void main() async {
  final apiKey = Platform.environment['DASHSCOPE_API_KEY'] ?? 'YOUR_API_KEY';

  // Qwen is compatible with the OpenAI Chat Completions API.
  // Just point OpenAIClient to the DashScope compatible base URL.
  final client = OpenAIClient(
    apiKey: apiKey,
    baseUrl: 'https://dashscope.aliyuncs.com/compatible-mode/v1',
  );

  final modelConfig = ModelConfig(model: 'qwen3.5-plus');
